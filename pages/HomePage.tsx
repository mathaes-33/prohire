    ...
    return (
        <div className="fade-in space-y-16 md:space-y-24 pb-16">
            <section className="relative pt-24 pb-32 text-center text-white overflow-hidden">
                 <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1521791136064-7986c2920216?q=80&w=1280&auto=format&fit=crop')" }}></div>
