        ...
        <div className="fade-in">
            <section className="relative text-white py-20 text-center overflow-hidden">
                <div className="absolute inset-0">
                    <img src="https://images.unsplash.com/photo-1527689368864-3a821dbccc34?q=80&w=1280&auto=format&fit=crop" alt="Office meeting" className="w-full h-full object-cover"/>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="hidden lg:block">
                            <img loading="lazy" decoding="async" src="https://plus.unsplash.com/premium_photo-1661726825011-f95313124c39?q=80&w=870&auto=format&fit=crop" alt="Business professionals collaborating in a meeting" className="rounded-lg shadow-xl aspect-[4/3] object-cover" />
                        </div>
                    </div>
                </div>
            </section>
